...
/** Premium equirectangular-style world map atmosphere for the hero. */
export function WorldMapBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_20%,_rgba(0,82,204,0.16),_transparent_50%),radial-gradient(ellipse_at_75%_60%,_rgba(244,180,0,0.08),_transparent_45%),linear-gradient(180deg,_rgba(248,250,252,0.2)_0%,_rgba(248,250,252,0.92)_84%)] dark:bg-[radial-gradient(ellipse_at_30%_20%,_rgba(26,107,255,0.24),_transparent_50%),radial-gradient(ellipse_at_75%_60%,_rgba(244,180,0,0.1),_transparent_45%),linear-gradient(180deg,_rgba(15,23,42,0.35)_0%,_rgba(15,23,42,0.96)_86%)]" />
